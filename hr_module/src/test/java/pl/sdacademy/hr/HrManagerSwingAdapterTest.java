...
public class HrManagerSwingAdapterTest {
	...
	@DisplayName("should add to empty table model new row matching employee created by HrManager given Adam " + "Miauczyński")
	@Test
	void test01() {
		//given
	...
	private HrManager fakeCreateHrManager() {
		return new HrManager() {
			...
			Employee create(String firstName, String lastName, String dateOfBirth) {
				if (firstName.equals("Adam") && lastName.equals("Miauczyński") && dateOfBirth.equals("11-11-1988"))
	...
	private HrManager fakeSortHrManager() {
		return new HrManager() {
			...
			public List<Employee> sortByFirstName() {
				return Arrays.asList(new Employee("Tomek", "Tomczuk", "09-09-1999"), new Employee("Igor", "Nowak", "08-08-1899"));

			}
		};
	}

	@DisplayName("zakladajac ze table model nie jest pusty, powinien zostac zastapiony table modelem zwroconym " + "przez metode sort z HrManagera")
	@Test
	void test03() {
		//given
		// create empty table model
